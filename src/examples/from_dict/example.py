...
def execute_analysis(input_data):
    ...
    try:
        results = run_full_lcc_analysis(
            input_data, life_cycle_construction_cost_breakdown, latex_report=True
        )

        print("[OK] LCC Analysis Completed Successfully.")
        print("[OK] LaTeX report generated as LCCA_Report.tex")
        return results

    except Exception as e:
        print("[ERROR] Error during LCC analysis:")
        print(e)
        return None
