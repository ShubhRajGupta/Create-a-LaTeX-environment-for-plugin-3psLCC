...
def run_full_lcc_analysis(
    ...
    Args:
        ...
        latex_report (bool, optional): If True, generates a .tex report; enables debug=True internally.
        latex_output_path (str, optional): Path for the .tex output. Defaults to 'LCCA_Report.tex'.
    ...
    if latex_report:
        generate_latex_report(input_data, construction_costs, results, latex_output_path)
